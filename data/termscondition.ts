...
export const headerDetails = {
    ...
    effectiveData: today.toISOString().split('T')[0], // Format today's data as YYYY MM DD
...
export const content = [
    {
        headsection1: "1. Acceptance of Terms",
        subsection1: [
            {
        ...
        headsection2: "2. Intellectual Property",
        subsection2: [
            {
        ...
        headsection3: "3. Limitations of Liability",
        subsection3: [
            {
        ...
        headsection4: "4. User Responsibilities",
        subsection4: [
            {
