    ...
    <Grid container spacing={2}>
      <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
        ...
        >
          ...
          >
            {adminContentLogoCarousel.adminContentLogoCarouselHeaderTitle}
          </Typography>
          <Box
            component="form"
            sx={{
          ...
          >
            ...
            >
              {adminContentLogoCarousel.adminContentLogoCarouselUploadButton}
        ...
        <Grid item xs={12} sm={12} md={12} lg={12} xl={12} marginTop={2}>
          <Box display="flex" justifyContent="end" alignItems="center">
            ...
            >
              ...
              >
                {adminContentLogoCarousel.adminContentLogoCarouselSubmitButton}
              </Typography>
            </Button>
          </Box>
        </Grid>
